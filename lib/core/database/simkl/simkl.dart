...
class Simkl extends Database {
  ...
  Future<List<SimklSearchResult>> search(String query) async {
    final url = "https://api.simkl.com/search/anime?q=$query&client_id=${KumaAnimeEnvironment.simklClientId}";
  ...
  Future<SimklInfo> getAnimeInfo(int id) async {
    final url = "https://api.simkl.com/anime/$id?extended=full&client_id=${KumaAnimeEnvironment.simklClientId}";
