...
class MiniResumePlayer extends StatelessWidget {
  ...
  void _resume(BuildContext context, Map<String, dynamic> session) {
    ...
    final epLinks = (session['epLinks'] as List)
        .map((e) => EpisodeDetails.fromMap(Map<String, dynamic>.from(e)))
        .toList();
      ...
      child: ConstrainedBox(
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Material(
              color: appTheme.backgroundSubColor.withValues(alpha: _isDark ? 0.6 : 0.65),
              child: InkWell(
